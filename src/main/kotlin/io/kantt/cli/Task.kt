...
class TaskList(private val projectService: ProjectService) : CliktCommand(name = "list") {
...
class TaskCreate(private val projectService: ProjectService) : CliktCommand(name = "create") {
    private val options by requireObject<Options>()
